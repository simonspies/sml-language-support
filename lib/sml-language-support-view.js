...
export default class SMLLanguageSupportView extends Emitter {
    ...
    search = /('a|'b|'c|'d|'e|'f|'g|'h|'i|'j|\bfn\b)/g
    mapping = {
        "'a": "\uD835\uDEFC",
        "'b": "\uD835\uDEFD",
        "'c": "\uD835\uDEFE",
    ...
    constructor() {
        ...
        this.on("add", (data) => {
            this.output.innerHTML += data.replace(this.search, (match) => {
    ...
    content() {
        ...
        this.input.setGrammar(atom.grammars.grammarForScopeName("source.ml"));
